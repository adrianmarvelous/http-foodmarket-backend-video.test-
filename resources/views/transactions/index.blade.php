                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border px-6-py-4">Queantity</th>
                    ...
                    <tbody>
                        @forelse ($transaction as $item)
                            <tr>
                                <td class="th border py-6 px-4">{{ $item->id }}</td>
                                <td class="th border py-6 px-4">{{ $item->user->name }}</td>
                                <td class="th border py-6 px-4">{{ $item->user->name }}</td>
                                <td class="th border py-6 px-4">{{ $item->quantity }}</td>
                                <td class="th border py-6 px-4">{{ number_format($item->total) }}</td>
                                <td class="th border py-6 px-4">{{ $item->status }}</td>
                                <td class="th border py-6 px-4">
